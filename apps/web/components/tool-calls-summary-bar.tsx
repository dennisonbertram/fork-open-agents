...
export function ToolCallsSummaryBar({
  ...
  const mountedResponseStatSegments = hasMounted ? responseStatSegments : [];
  const fullSummary = [
    statusLabel,
    ...desktopSegments,
    ...mountedResponseStatSegments,
  ].join(" · ");
